...
namespace energyplus {
  ...
  boost::optional<IdfObject> ForwardTranslator::translateCoilHeatingWaterToAirHeatPumpVariableSpeedEquationFit(
    CoilHeatingWaterToAirHeatPumpVariableSpeedEquationFit& modelObject) {
    ...
    if (auto node = modelObject.waterOutletModelObject()) {
      idfObject.setString(Coil_Heating_WaterToAirHeatPump_VariableSpeedEquationFitFields::WatertoRefrigerantHXWaterOutletNodeName,
                          node->name().get());
    }
    ...
    if (modelObject.isRatedHeatingCapacityAtSelectedNominalSpeedLevelAutosized()) {
      idfObject.setString(Coil_Heating_WaterToAirHeatPump_VariableSpeedEquationFitFields::RatedHeatingCapacityAtSelectedNominalSpeedLevel,
                          "AutoSize");
    } else if ((value = modelObject.ratedHeatingCapacityAtSelectedNominalSpeedLevel())) {
      idfObject.setDouble(Coil_Heating_WaterToAirHeatPump_VariableSpeedEquationFitFields::RatedHeatingCapacityAtSelectedNominalSpeedLevel,
                          value.get());
    }
    ...
    for (auto const& speed : speeds) {
      ...
      if ((value = speed.referenceUnitGrossRatedHeatingCapacity())) {
        eg.setDouble(Coil_Heating_WaterToAirHeatPump_VariableSpeedEquationFitExtensibleFields::SpeedReferenceUnitGrossRatedHeatingCapacity,
                     value.get());
      }
      ...
      // SpeedHeatingCapacityFunctionofTemperatureCurveName
      {
        ...
        if (auto _curve = translateAndMapModelObject(curve)) {
          eg.setString(Coil_Heating_WaterToAirHeatPump_VariableSpeedEquationFitExtensibleFields::SpeedHeatingCapacityFunctionofTemperatureCurveName,
                       _curve->name().get());
        }
      }
      ...
      // SpeedHeatingCapacityFunctionofWaterFlowFractionCurveName
      {
        ...
        if (auto _curve = translateAndMapModelObject(curve)) {
          eg.setString(
            Coil_Heating_WaterToAirHeatPump_VariableSpeedEquationFitExtensibleFields::SpeedHeatingCapacityFunctionofWaterFlowFractionCurveName,
            _curve->name().get());
        }
      }
      ...
      // SpeedEnergyInputRatioFunctionofTemperatureCurveName
      {
        ...
        if (auto _curve = translateAndMapModelObject(curve)) {
          eg.setString(Coil_Heating_WaterToAirHeatPump_VariableSpeedEquationFitExtensibleFields::SpeedEnergyInputRatioFunctionofTemperatureCurveName,
                       _curve->name().get());
        }
      }
      ...
      // SpeedEnergyInputRatioFunctionofAirFlowFractionCurveName
      {
        ...
        if (auto _curve = translateAndMapModelObject(curve)) {
          eg.setString(
            Coil_Heating_WaterToAirHeatPump_VariableSpeedEquationFitExtensibleFields::SpeedEnergyInputRatioFunctionofAirFlowFractionCurveName,
            _curve->name().get());
        }
      }
      ...
      // SpeedWasteHeatFunctionofTemperatureCurveName
      {
        ...
        if (auto _curve = translateAndMapModelObject(curve)) {
          eg.setString(Coil_Heating_WaterToAirHeatPump_VariableSpeedEquationFitExtensibleFields::SpeedWasteHeatFunctionofTemperatureCurveName,
                       _curve->name().get());
        }
      }
    }
