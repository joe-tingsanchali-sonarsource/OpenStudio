...
MODELOBJECT_TEMPLATES(CoilHeatingSteam);
...
MODELOBJECT_TEMPLATES(HeatPumpAirToWaterCooling);
...
SWIG_MODELOBJECT(CoilHeatingSteam, 1);
...
SWIG_MODELOBJECT(HeatPumpAirToWaterCooling, 1);
