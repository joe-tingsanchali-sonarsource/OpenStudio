...
namespace model {
  ...
  namespace detail {
    ...
    AirflowNetworkEquivalentDuct CoilHeatingElectricMultiStage_Impl::getAirflowNetworkEquivalentDuct(double length, double diameter) {
    ...
    boost::optional<AirflowNetworkEquivalentDuct> CoilHeatingElectricMultiStage_Impl::airflowNetworkEquivalentDuct() const {
  ...
  AirflowNetworkEquivalentDuct CoilHeatingElectricMultiStage::getAirflowNetworkEquivalentDuct(double length, double diameter) {
    return getImpl<detail::CoilHeatingElectricMultiStage_Impl>()->getAirflowNetworkEquivalentDuct(length, diameter);
  }

  boost::optional<AirflowNetworkEquivalentDuct> CoilHeatingElectricMultiStage::airflowNetworkEquivalentDuct() const {
    return getImpl<detail::CoilHeatingElectricMultiStage_Impl>()->airflowNetworkEquivalentDuct();
  }
